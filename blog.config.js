...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '高颢嘉', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个渴望借助机器人探索宇宙的 Coder', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.gaohaojia.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '个人网站,博客,高颢嘉,颢嘉,Haojia Gao,Haojia,Gao,颢见万象,嘉行智途,Vision the Cosmos,Navigate Intelligence', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备2022004611号', // 备案号 闽ICP备XXXXXX
